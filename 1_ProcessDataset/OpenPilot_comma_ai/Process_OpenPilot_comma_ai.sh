...
# Declare directorys
INPUT_DIRECTORY="../../0_Datasets/Data/OpenPilot_comma_ai/0_OriginalData/"
OUTPUT_DIRECTORY="../../0_Datasets/Data/OpenPilot_comma_ai/1_ProcessedData/"
...
for folder in "$INPUT_DIRECTORY"/CommaAi/imgFormat/*/; do
    ...
    ffmpeg -i "$output_video_20" -r 15 -c:v libx264 -pix_fmt yuv420p "$output_video_15"
