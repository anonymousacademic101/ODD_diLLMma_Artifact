...
DATASET_DIRECTORY = "../0_Datasets/Data"
...
parser.add_argument('--dataset',
                    type=str,
                    required=True,
                    choices=["OpenPilot_2k19", "External_jutah", "OpenPilot_comma_ai"],
                    help="The dataset you want to process (OpenPilot_2k19, External_jutah, OpenPilot_comma_ai)")
...
# Load the prompts
with open(f'../0_Datasets/ODD/{args.odd_file}', 'r') as file:
